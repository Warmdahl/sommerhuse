                        ...
                        {/if}
                                <div class="col-sm-12 col-md-6 margin-btm-30">
                                    ...
                                    <div class="hotelRoomDescContainer">
                                        ...
                                        <div class="row margin-lr-0">
                                            <a class="btn btn-default button htlRoomTypeBookNow" href="{$link->getProductLink($roomDisplay.id_product)|escape:'html':'UTF-8'}"><span>{if !isset($restricted_country_mode) && !$PS_CATALOG_MODE}{l s='Reserver' mod='wkhotelroom'}{else}{l s='View' mod='wkhotelroom'}{/if}</span></a>
                                        </div>
                                    </div>
                                </div>
                        {if !($smarty.foreach.htlRoom.iteration%2)}
