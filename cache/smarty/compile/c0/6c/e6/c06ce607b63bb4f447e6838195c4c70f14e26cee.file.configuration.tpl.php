<?php /* Smarty version Smarty-3.1.19, created on 2022-10-20 07:01:31
         compiled from "/home/qloapps/www/hotelcommerce/adminsommerhus/themes/default/template/controllers/products/configuration.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7894398856350d62bd0a267-03610673%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c06ce607b63bb4f447e6838195c4c70f14e26cee' => 
    array (
      0 => '/home/qloapps/www/hotelcommerce/adminsommerhus/themes/default/template/controllers/products/configuration.tpl',
      1 => 1617953772,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7894398856350d62bd0a267-03610673',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6350d62bda7501_80976425',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6350d62bda7501_80976425')) {function content_6350d62bda7501_80976425($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['product']->value->id)) {?>
	<div id="product-configuration" class="panel product-tab">
		<input type="hidden" name="submitted_tabs[]" value="Configuration" />
		<h3 class="tab"> <i class="icon-AdminAdmin"></i> <?php echo smartyTranslate(array('s'=>'Configuration'),$_smarty_tpl);?>
</h3>
			...
			<table class="table hotel-room">
				<thead>
					<tr class="nodrag nodrop">
						...
						<th class="col-sm-2 center">
							<span><?php echo smartyTranslate(array('s'=>'Floor'),$_smarty_tpl);?>
</span>
						</th>
						<th class="col-sm-2">
							<span><?php echo smartyTranslate(array('s'=>'Status'),$_smarty_tpl);?>
</span>
						</th>
						<th class="col-sm-6 center">
							<span><?php echo smartyTranslate(array('s'=>'Extra Information'),$_smarty_tpl);?>
</span>
						</th>
					</tr>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['info']->value['id_status']==$_tmp1) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['room_stauts']->value['status'];?>
								...
								<td class="center col-sm-6">
									<a class="btn btn-default deactiveDatesModal" data-toggle="modal" data-target="#deactiveDatesModal" <?php if ($_smarty_tpl->tpl_vars['info']->value['id_status']!=3) {?>style="display: none;"<?php }?>><?php if ($_smarty_tpl->tpl_vars['info']->value['id_status']!=3) {?><?php echo smartyTranslate(array('s'=>'Add Dates'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'View Dates'),$_smarty_tpl);?>
<?php }?>
									</a>
...
"><?php echo $_smarty_tpl->tpl_vars['room_stauts']->value['status'];?>
								...
								<td class="center col-sm-6">
									<a class="deactiveDatesModal" data-toggle="modal" data-target="#deactiveDatesModal" style="display: none;">
										<?php echo smartyTranslate(array('s'=>'add Dates'),$_smarty_tpl);?>
			...
			<div class="form-group">
				<div class="col-sm-12">
					<button id="add-more-rooms-button" class="btn btn-default" type="button" data-size="s" data-style="expand-right">
						...
						<?php echo smartyTranslate(array('s'=>'Add More Rooms'),$_smarty_tpl);?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="icon-calendar"></i>&nbsp; <?php echo smartyTranslate(array('s'=>'Disable dates'),$_smarty_tpl);?>
</h4>
			</div>
			<div class="modal-body">
				<div class="from-group table-responsive-row clearfix">
						...
						<thead>
							<tr class="nodrag nodrop">
								<th class="col-sm-1 center">
									<span><?php echo smartyTranslate(array('s'=>'Date From'),$_smarty_tpl);?>
</span>
								</th>
								<th class="col-sm-2 center">
									<span><?php echo smartyTranslate(array('s'=>'Date To'),$_smarty_tpl);?>
</span>
								</th>
								<th class="col-sm-2 center">
									<span><?php echo smartyTranslate(array('s'=>'Reason'),$_smarty_tpl);?>
</span>
								</th>
							</tr>
						</thead>
					...
					<div class="form-group">
						<div class="col-sm-12">
							<a href="#" class="add_more_room_disable_dates btn btn-default"><i class="icon icon-plus"></i><?php echo smartyTranslate(array('s'=>"Add More"),$_smarty_tpl);?>
</a>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default deactiveDatesModalSubmit"><?php echo smartyTranslate(array('s'=>'Done'),$_smarty_tpl);?>
</button>
			</div>
		</div>
	</div>
			...
			html = '<tr class="room_data_values" id="row_index'+lengthRooms+'" data-rowKey="'+lengthRooms+'">';
				...
				html += '<td class="center col-sm-6">';
					html += '<a class="btn btn-default deactiveDatesModal" data-toggle="modal" data-target="#deactiveDatesModal" style="display: none;">';
						html += "<?php echo smartyTranslate(array('s'=>'Add Dates'),$_smarty_tpl);?>
";
					html += '</a>';
...
");
						...
						showErrorMessage("<?php echo smartyTranslate(array('s'=>'Some error occurred'),$_smarty_tpl);?>
");
					}
	            },
