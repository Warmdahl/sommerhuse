<?php /* Smarty version Smarty-3.1.19, created on 2022-10-20 07:01:32
         compiled from "/home/qloapps/www/hotelcommerce/adminsommerhus/themes/default/template/controllers/products/booking.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15521139616350d62c3abbb5-07128734%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd5037d10105025f71f6b6ef65a6b65b2313092c' => 
    array (
      0 => '/home/qloapps/www/hotelcommerce/adminsommerhus/themes/default/template/controllers/products/booking.tpl',
      1 => 1617953772,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15521139616350d62c3abbb5-07128734',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6350d62c3f75d8_15039091',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6350d62c3f75d8_15039091')) {function content_6350d62c3f75d8_15039091($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/qloapps/www/hotelcommerce/tools/smarty/plugins/modifier.date_format.php';
?><?php if (isset($_smarty_tpl->tpl_vars['product']->value->id)&&isset($_smarty_tpl->tpl_vars['htl_config']->value)) {?>
	<div id="product-configuration" class="panel product-tab">
		...
		<h3 class="tab"> <i class="icon-info"></i> <?php echo smartyTranslate(array('s'=>'Booking Information'),$_smarty_tpl);?>
</h3>
			...
			<div class="col-sm-5 htl_room_data_cont">
					...
					<div class="col-sm-6">
						<div class="row">
							<div class="col-sm-12 htl_room_cat_data">
								<p class="room_cat_header"><?php echo smartyTranslate(array('s'=>'Total Rooms'),$_smarty_tpl);?>
</p>
					...
					<div class="col-sm-6">
						<div class="row">
							<div class="col-sm-12 htl_room_cat_data no_border">
								<p class="room_cat_header"><?php echo smartyTranslate(array('s'=>'Partially Available'),$_smarty_tpl);?>
</p>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="row">
							<div class="col-sm-12 htl_room_cat_data">
								<p class="room_cat_header"><?php echo smartyTranslate(array('s'=>'Available Rooms'),$_smarty_tpl);?>
</p>
					...
					<div class="col-sm-6">
						<div class="row">
							<div class="col-sm-12 htl_room_cat_data no_border">
								<p class="room_cat_header"><?php echo smartyTranslate(array('s'=>'Booked Rooms'),$_smarty_tpl);?>
</p>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="row">
							<div class="col-sm-12 htl_room_cat_data">
								<p class="room_cat_header"><?php echo smartyTranslate(array('s'=>'Unavailable Rooms'),$_smarty_tpl);?>
</p>
				...
				<div class="row">
					<div class="col-sm-6 indi_cont clearfix">
						...
						<span class="indi_label"><?php echo smartyTranslate(array('s'=>'Available Rooms'),$_smarty_tpl);?>
</span>
					</div>
					<div class="col-sm-6 indi_cont clearfix">
						<div class="color_indicate bg-yellow"></div>
						<span class="indi_label"><?php echo smartyTranslate(array('s'=>'Partially Available'),$_smarty_tpl);?>
</span>
					</div>
					<div class="col-sm-6 indi_cont clearfix">
						<div class="color_indicate bg-red"></div>
						<span class="indi_label"><?php echo smartyTranslate(array('s'=>'Unavailable Rooms'),$_smarty_tpl);?>
</span>
					</div>
					<div class="col-sm-6 indi_cont clearfix">
						<div class="color_indicate bg-gray"></div>
						<span class="indi_label"><?php echo smartyTranslate(array('s'=>'Hold For Maintenance'),$_smarty_tpl);?>
</span>
					</div>
				</div>
			</div>
...
<?php }?>" class="btn btn-default">
	...
	<div class="panel">
		<h3 class="tab"> <i class="icon-list"></i> <?php echo smartyTranslate(array('s'=>'LIST OF HOTEL ROOMS'),$_smarty_tpl);?>
</h3>
		<div class="form-group">
...
?>
									<tr>
										...
										<td><?php echo smartyTranslate(array('s'=>'Available'),$_smarty_tpl);?>
</td>
...
?>
									<tr>
										...
										<td><?php echo smartyTranslate(array('s'=>'Unavailable'),$_smarty_tpl);?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['data_v']->value['room_comment'];?>
</td>
									</tr>
									...
									<tr>
										...
										<td>
											<?php if ($_smarty_tpl->tpl_vars['data_v']->value['detail'][0]['booking_status']==1) {?>
												<?php echo smartyTranslate(array('s'=>'Alloted'),$_smarty_tpl);?>

											<?php } elseif ($_smarty_tpl->tpl_vars['data_v']->value['detail'][0]['booking_status']==2) {?>
												<?php echo smartyTranslate(array('s'=>'Checked-in'),$_smarty_tpl);?>

											<?php } elseif ($_smarty_tpl->tpl_vars['data_v']->value['detail'][0]['booking_status']==3) {?>
												<?php echo smartyTranslate(array('s'=>'Checked-out'),$_smarty_tpl);?>
...
?>
									<tr>
										...
										<td><?php echo smartyTranslate(array('s'=>'Partially Available'),$_smarty_tpl);?>
</td>
