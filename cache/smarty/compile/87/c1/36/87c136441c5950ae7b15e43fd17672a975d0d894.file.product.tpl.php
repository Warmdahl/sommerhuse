<?php /* Smarty version Smarty-3.1.19, created on 2023-01-02 11:38:43
         compiled from "/home/qloapps/www/hotelcommerce/themes/hotel-reservation-theme/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2023709363b2b433090ce5-83879707%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87c136441c5950ae7b15e43fd17672a975d0d894' => 
    array (
      0 => '/home/qloapps/www/hotelcommerce/themes/hotel-reservation-theme/product.tpl',
      1 => 1666120805,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2023709363b2b433090ce5-83879707',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_63b2b4331f8386_58778670',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_63b2b4331f8386_58778670')) {function content_63b2b4331f8386_58778670($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/qloapps/www/hotelcommerce/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/home/qloapps/www/hotelcommerce/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/qloapps/www/hotelcommerce/tools/smarty/plugins/function.counter.php';
?>
...
"/>
                                    ...
                                    <?php }?>
                                    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayRoomTypeImageAfter"),$_smarty_tpl);?>
                    ...
                    <div class="room_type_info_containter">
                        ...
                        <section class="page-product-box">
                            <ul class="nav nav-tabs product_description_tabs">
                                <li class="active"><a href="#room_info_tab" class="idTabHrefShort" data-toggle="tab"><?php echo smartyTranslate(array('s'=>'Room Information'),$_smarty_tpl);?>
</a></li>
                                <li><a href="#refund_policies_tab" class="idTabHrefShort" data-toggle="tab"><?php echo smartyTranslate(array('s'=>'Refund policies'),$_smarty_tpl);?>
</a></li>
...
" width="15px" src="<?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ftr_v']->value['value'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp7=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getMediaLink(((string)htmlspecialchars($_smarty_tpl->tpl_vars['ftr_img_src']->value, ENT_QUOTES, 'UTF-8', true)).$_tmp7);?>
">&nbsp;
                                                    <?php } ?>
                                                </div>
                                            </div>
...
?>
 ...
 $_from = $_smarty_tpl->tpl_vars['hotelRefundRules']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
 ...
 - </span> <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['refundRule']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
                                            ...
                                            <?php } ?>
                                        <?php } else { ?>
                                            <?php echo smartyTranslate(array('s'=>'N/A'),$_smarty_tpl);?>

                                        <?php }?>
                                    <?php } else { ?>
                                        <span class="non_refundable_txt error_msg"><?php echo smartyTranslate(array('s'=>'Non Refundable'),$_smarty_tpl);?>
</span>
                                    <?php }?>
                                </div>
                            ...
                            <div class="booking_room_fields">
                                <form action="" method="post">
                                    <div class="form-group htl_location_block">
                                        <label for="" class="control-label"><?php echo smartyTranslate(array('s'=>'Hotel lokation'),$_smarty_tpl);?>
</label>
...
<?php }?>">
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['order_date_restrict']->value) {?>
                                        <div class="order_restrict_alert">
                                            <span><?php echo smartyTranslate(array('s'=>'You can\'t book for rooms after date'),$_smarty_tpl);?>
...
<?php $_tmp8=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_tmp8),$_smarty_tpl);?>
</span><?php }?></p>
...
<?php $_tmp9=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"qty=1&amp;id_product=".$_tmp9."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;add"), ENT_QUOTES, 'UTF-8', true);?>
