<?php /* Smarty version Smarty-3.1.19, created on 2022-10-22 09:03:28
         compiled from "/home/qloapps/www/hotelcommerce/themes/hotel-reservation-theme/order-confirmation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1503696478635395c0678e16-45793053%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06819874227ac75d9006f9ebbc1adb90a886dec0' => 
    array (
      0 => '/home/qloapps/www/hotelcommerce/themes/hotel-reservation-theme/order-confirmation.tpl',
      1 => 1617953773,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1503696478635395c0678e16-45793053',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_635395c06bfa58_38979204',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_635395c06bfa58_38979204')) {function content_635395c06bfa58_38979204($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/qloapps/www/hotelcommerce/tools/smarty/plugins/modifier.date_format.php';
?>
					...
					<tfoot>
						<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value&&$_smarty_tpl->tpl_vars['use_tax']->value) {?>
							<tr class="item">
								<td colspan="3"></td>
								<td colspan="3">
									<strong><?php echo smartyTranslate(array('s'=>'Rooms (tax excl.)'),$_smarty_tpl);?>
</strong>
								</td>
								<td colspan="2">
						...
						<tr class="item">
							<td colspan="3"></td>
							<td colspan="3">
								<strong><?php echo smartyTranslate(array('s'=>'Rooms'),$_smarty_tpl);?>
...
<?php }?> </strong>
						...
						<?php if ($_smarty_tpl->tpl_vars['orderTotalInfo']->value['total_demands_price_te']>0) {?>
							<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value&&$_smarty_tpl->tpl_vars['use_tax']->value) {?>
								<tr class="item">
									...
									<td colspan="2">
										<span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['orderTotalInfo']->value['total_demands_price_te'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
									</td>
								</tr>
							<?php }?>
							<tr class="item">
								...
								<td colspan="2">
									<span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['orderTotalInfo']->value['total_demands_price_ti'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>1),$_smarty_tpl);?>
</span>
								</td>
							</tr>
						<?php }?>
						...
						<tr class="totalprice item">
							<td colspan="3"></td>
							<td colspan="3">
								<strong><?php echo smartyTranslate(array('s'=>'Final Booking Total'),$_smarty_tpl);?>
</strong>
							</td>
							<td colspan="2">
			...
			<p><?php echo smartyTranslate(array('s'=>'An email has been sent with this information.'),$_smarty_tpl);?>

				<br /><strong><?php echo smartyTranslate(array('s'=>'Your order will be sent as soon as we receive payment.'),$_smarty_tpl);?>
</strong>
				<br /><?php echo smartyTranslate(array('s'=>'If you have questions, comments or concerns, please contact our'),$_smarty_tpl);?>
...
"><?php echo smartyTranslate(array('s'=>'expert customer support team'),$_smarty_tpl);?>
</a>
			</p>
		</div>
	<?php }?>
