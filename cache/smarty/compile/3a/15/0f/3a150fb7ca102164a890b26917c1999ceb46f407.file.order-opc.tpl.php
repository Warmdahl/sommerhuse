<?php /* Smarty version Smarty-3.1.19, created on 2022-10-22 09:23:13
         compiled from "/home/qloapps/www/hotelcommerce/themes/hotel-reservation-theme/order-opc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15040727363539a61901496-71328396%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a150fb7ca102164a890b26917c1999ceb46f407' => 
    array (
      0 => '/home/qloapps/www/hotelcommerce/themes/hotel-reservation-theme/order-opc.tpl',
      1 => 1617953773,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15040727363539a61901496-71328396',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'display_tax_label' => 0,
    'total_products' => 0,
    'totalFacilityCostTE' => 0,
    'use_taxes' => 0,
    'show_taxes' => 0,
    'total_tax' => 0,
    'priceDisplay' => 0,
    'total_price_without_tax' => 0,
    'additional_facilities_tax' => 0,
    'total_wrapping' => 0,
  ...
  'unifunc' => 'content_63539a61983318_39257632',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_63539a61983318_39257632')) {function content_63539a61983318_39257632($_smarty_tpl) {?>
		...
		<section id="content">
			<div class="row">
				<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
					<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Your booking cart'),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
					...
					<h2 class="page-heading"><?php echo smartyTranslate(array('s'=>'Your booking cart'),$_smarty_tpl);?>
</h2>

					<p class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'The hotel is currently no accepting any bookings.'),$_smarty_tpl);?>
</p>
				<?php } else { ?>
														...
														<div class="card-body">
															<?php if ($_smarty_tpl->tpl_vars['is_logged']->value||$_smarty_tpl->tpl_vars['isGuest']->value) {?>
																<div class="row margin-btm-10">
																	<div class="col-sm-3 col-xs-5 info-head"><?php echo smartyTranslate(array('s'=>'Name'),$_smarty_tpl);?>
</div>
																	...
																	<div class="row margin-btm-10">
																		<div class="col-sm-3 col-xs-5 info-head">
																			<?php if (isset($_smarty_tpl->tpl_vars['delivery']->value->phone_mobile)&&$_smarty_tpl->tpl_vars['delivery']->value->phone_mobile) {?>
																				<?php echo smartyTranslate(array('s'=>'Mobile Number'),$_smarty_tpl);?>
...
<?php }?></span>
								...
								<?php if (isset($_smarty_tpl->tpl_vars['totalFacilityCostTE']->value)&&$_smarty_tpl->tpl_vars['totalFacilityCostTE']->value) {?>
									<p>
										<span><?php echo smartyTranslate(array('s'=>'Total additional facilities'),$_smarty_tpl);?>
<?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>' (tax excl.)'),$_smarty_tpl);?>
<?php }?></span>
										<span class="cart_total_values"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['totalFacilityCostTE']->value),$_smarty_tpl);?>
</span>
									</p>
								<?php }?>
...
<?php }?></span>
									...
									<p class="cart_total_tax">
										<span><?php echo smartyTranslate(array('s'=>'Tax on rooms'),$_smarty_tpl);?>
</span>
										<span class="cart_total_values"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>($_smarty_tpl->tpl_vars['total_tax']->value-$_smarty_tpl->tpl_vars['additional_facilities_tax']->value)),$_smarty_tpl);?>
</span>
									</p>
								<?php }?>
								<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value&&$_smarty_tpl->tpl_vars['additional_facilities_tax']->value!=0) {?>
									<p class="cart_total_tax">
										<span><?php echo smartyTranslate(array('s'=>'Tax on facilities'),$_smarty_tpl);?>
</span>
										<span class="cart_total_values"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['additional_facilities_tax']->value),$_smarty_tpl);?>
</span>
									</p>
								<?php }?>
...
<?php }?>
								...
								<?php if (isset($_smarty_tpl->tpl_vars['is_advance_payment']->value)&&$_smarty_tpl->tpl_vars['is_advance_payment']->value) {?>
									<p>
										...
										<span class="cart_total_values"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['advPaymentAmount']->value),$_smarty_tpl);?>
</span>
									</p>
									<p>
										<span><?php echo smartyTranslate(array('s'=>'Due Amount'),$_smarty_tpl);?>
</span>
										<span class="cart_total_values"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['dueAmount']->value),$_smarty_tpl);?>
</span>
									</p>
								<?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
						...
						<p class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Till now you did not added any room in your cart.'),$_smarty_tpl);?>
</p>
					<?php }?>
